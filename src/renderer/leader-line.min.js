...
var LeaderLine = (function () {
	...
	var Z,
			...
			function (e) {
				return (
					...
					(!(e = Object.getPrototypeOf(e)) ||
						((e = e.hasOwnProperty('constructor') && e.constructor) && 'function' == typeof e && c.call(e) === d))
				)
			}),
		pe =
			Number.isFinite ||
						...
						if (((s = v / t), (r = [g(0, 0)]), 0 === i[0] && 0 === i[1] && 1 === i[2] && 1 === i[3]))
							...
							for (p = u = (h = s) / 10; p <= 1; p += u)
								((d = p),
									...
									(f = (m = p * p) * p),
									(m *= 3 * (y = 1 - p)),
									h <= (c = { x: (d = 3 * (y * y) * p) * i[0] + m * i[2] + f, y: d * i[1] + m * i[3] + f }).x &&
										(r.push(g(c.x, c.y)), (h += s)))
						r.push(g(1, 1))
					}
						...
						E.some(function (e) {
							return (
								...
								(n
									...
									: ((a = (Date.now() - e.framesStart) / e.duration), (a = e.reverse ? 1 - a : a) < 0 ? (a = 0) : 1 < a && (a = 1)),
								!(e.framesStart = null))
							)
						}),
						a
		...
		ce = function (e, t) {
			;(e.SVGPathElement.prototype.getPathData && e.SVGPathElement.prototype.setPathData && !t) ||
				(function () {
					function i(e) {
						;((this._string = e),
					...
					var s = e.SVGPathElement.prototype.setAttribute,
						...
						b = function (e, t, n, a, i, o, l, r, s, u) {
							...
							u
								...
								: ((e = (m = h(e, t, -p)).x),
									(t = m.y),
									1 < (m = ((y = (e - (n = (f = h(n, a, -p)).x)) / 2) * y) / (i * i) + ((d = (t - (a = f.y)) / 2) * d) / (o * o)) &&
										((i *= m = Math.sqrt(m)), (o *= m)),
									(f = i * i),
									(m = o * o),
									(S =
										((f = (r === s ? -1 : 1) * Math.sqrt(Math.abs((f * m - f * d * d - m * y * y) / (f * d * d + m * y * y)))) *
											i *
											d) /
											o +
										(e + n) / 2),
	...
	function Ue(e, t, n, a, i, o, l) {
		...
		;('auto-start-reverse' === n
			? ('boolean' != typeof s &&
					(t.setAttribute('orient', 'auto-start-reverse'), (s = t.orientType.baseVal === SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN)),
				s
	...
	function qe(e) {
		...
		return (
			'static' !== e.position
				? ((n.x -= [a.marginLeft, a.borderLeftWidth, a.paddingLeft, e.marginLeft, e.borderLeftWidth].reduce(t, 0)),
					(n.y -= [a.marginTop, a.borderTopWidth, a.paddingTop, e.marginTop, e.borderTopWidth].reduce(t, 0)))
				: 'static' !== a.position &&
					((n.x -= [a.marginLeft, a.borderLeftWidth].reduce(t, 0)), (n.y -= [a.marginTop, a.borderTopWidth].reduce(t, 0))),
			n
		)
	}
	function Qe(e) {
		var t,
			n = e.document
		n.getElementById(f) || ((t = new e.DOMParser().parseFromString(y, 'image/svg+xml')), n.body.appendChild(t.documentElement), ce(e, oe))
	}
	function Ke(l) {
		var g,
			c,
				...
				[0, 1].some(function (e) {
					return (
						...
						(e = null == t ? 'auto' : Array.isArray(t) ? 'array' : 'number') !=
							(null == n ? 'auto' : Array.isArray(n) ? 'array' : 'number') || ('array' == e ? t[0] !== n[0] || t[1] !== n[1] : t !== n))
					)
					var t, n
				}))
		) {
										...
										: ((n = v[t ? 0 : 1]),
											(a =
												0 < (a = f.position_plugOverheadSE[t])
													? U + (K < a ? (a - K) * J : 0)
													: z + (f.position_lineStrokeWidth > j ? (f.position_lineStrokeWidth - j) * H : 0)),
											e.socketId === b
											...
											s.forEach(function (e, t) {
												...
												;(e.push(u[t]),
													(u[t] = c(
														u[t],
														ee,
														2 * ee <= a ? S(u[t], u[n], 'x' === o[t] ? 'y' : 'x') : 'x' === o[t] ? r : l
													)))
											}))
								} else {
									if (n[0] && n[1])
										return void (f(u[1], u[0])
											...
											: f(u[0], u[1])
												? s[0].push(u[0])
												: s[0].push('x' === o[0] ? { x: u[1].x, y: u[0].y } : { x: u[0].x, y: u[1].y }))
									n[0] !== n[1]
										? ((t = y(n)),
											s[t.notContain].push(u[t.notContain]),
											(u[t.notContain] = c(
		...
		;(t.line &&
			...
			(t.lineOutline || U.line) &&
				(U.lineOutline =
					...
					(k =
						Xe(i, l, 'lineOutline_inStrokeWidth', l.lineOutline_colorTra ? l.lineOutline_strokeWidth + 2 * se : l.line_strokeWidth - o) ||
						k))),
					...
					[0, 1].forEach(function (e) {
						...
						;((y =
							Xe(
								...
								e,
								s.plugOutlineEnabledSE[e] && u.plug_enabled && u.plug_enabledSE[e] && !!n && !!n.outlineBase
							) || y),
							...
							n &&
								...
								(y =
									Xe(
										...
										e,
										u.plugOutline_colorTraSE[e] ? t - (se / (u.line_strokeWidth / ue.lineSize) / s.plugSizeSE[e]) * 2 : t / 2
									) || y)))
					}),
					y)),
					...
					g.plug_enabled &&
						[0, 1].forEach(function (n) {
							...
							;(Xe(m, _.plug_enabledSE, n, (S = g.plug_enabledSE[n]), v.apl_plug_enabledSE) &&
								((m.plugsFace.style[a.prop] = S ? 'url(#' + m.plugMarkerIdSE[n] + ')' : 'none'), (E = !0)),
								g.plug_enabledSE[n] &&
									(Xe(m, _.plug_plugSE, n, e, v.apl_plug_plugSE) &&
										((m.plugFaceSE[n].href.baseVal = '#' + t.elmId),
										Ue(m, m.plugMarkerSE[n], a.orient, t.bBox, m.svg, m.plugMarkerShapeSE[n], m.plugsFace),
										(E = !0),
										oe && je(m, m.plugsFace)),
									Xe(m, _.plug_colorSE, n, (S = g.plug_colorSE[n]), v.apl_plug_colorSE) &&
										((m.plugFaceSE[n].style.fill = S),
										(E = !0),
										(le || re || ie) && !g.line_colorTra && je(m, ie ? m.lineMaskCaps : m.capsMaskLine)),
			...
			(U.mask =
				...
				R.plug_enabled
					? [0, 1].forEach(function (e) {
							R.capsMaskMarker_enabledSE[e] =
								(R.plug_enabledSE[e] && R.plug_colorTraSE[e]) || (R.plugOutline_enabledSE[e] && R.plugOutline_colorTraSE[e])
						})
				...
				Xe(W, F, 'lineMask_enabled', (B = R.lineMask_enabled)) &&
					((W.lineFace.style.mask = B ? 'url(#' + W.lineMaskId + ')' : 'none'), (G = !0), re && je(W, W.lineMask)),
				R.lineMask_enabled &&
					...
					Xe(W, F, 'caps_enabled', (B = R.caps_enabled)) &&
						((W.lineMaskCaps.style.display = W.lineOutlineMaskCaps.style.display = B ? 'inline' : 'none'),
						(G = !0),
					...
					R.caps_enabled &&
						([0, 1].forEach(function (e) {
							...
							;(Xe(W, F.capsMaskAnchor_enabledSE, e, (B = R.capsMaskAnchor_enabledSE[e])) &&
								((W.capsMaskAnchorSE[e].style.display = B ? 'inline' : 'none'), (G = !0), re && je(W, W.lineMask)),
								R.capsMaskAnchor_enabledSE[e] &&
									(Fe((t = R.capsMaskAnchor_pathDataSE[e]), F.capsMaskAnchor_pathDataSE[e]) &&
										(W.capsMaskAnchorSE[e].setPathData(t), (F.capsMaskAnchor_pathDataSE[e] = t), (G = !0)),
									Xe(W, F.capsMaskAnchor_strokeWidthSE, e, (B = R.capsMaskAnchor_strokeWidthSE[e])) &&
						...
						R.capsMaskMarker_enabled &&
							[0, 1].forEach(function (n) {
								...
								;(Xe(W, F.capsMaskMarker_enabledSE, n, (B = R.capsMaskMarker_enabledSE[n])) &&
									((W.capsMaskLine.style[a.prop] = B ? 'url(#' + W.lineMaskMarkerIdSE[n] + ')' : 'none'), (G = !0)),
	...
	function it(s, u) {
		...
		function _(e, t, n, a, i) {
			var o = {}
			return (
				n ? (null != a ? ((o.container = e[n]), (o.key = a)) : ((o.container = e), (o.key = n))) : ((o.container = e), (o.key = t)),
				(o.default = i),
			...
			return (
				null != t[n] &&
					((l.acceptsAuto && (t[n] + '').toLowerCase() === D) ||
						((p = h = t[n]),
						('number' === (c = a) ? pe(p) : typeof p === c) && ((h = s && 'string' === a && h ? h.trim() : h), 1) && (!r || r(h)))) &&
					h !== l.container[l.key] &&
		...
		if (
			...
			['start', 'end'].forEach(function (e, t) {
				...
				if (n && (Me(n) || (a = I(n, 'anchor'))) && n !== S.anchorSE[t]) {
					if ((!1 !== s.optionIsAttach.anchorSE[t] && at(s, _e[S.anchorSE[t]._id]), a && !nt(s, _e[n._id], e)))
					...
					return (
						o.optionsConf.forEach(function (e) {
							var t = e[0],
								n = e[3]
							;(null == e[4] || i[n] || (i[n] = []),
								('function' == typeof t ? t : 'id' === t ? v : E).apply(null, [i, a].concat(e.slice(1))))
						}),
						i
					)
				}
	...
	function rt(e, t) {
		...
		;(e.argOptions.every(function (e) {
			return (
				!(!t.length || ('string' == typeof e.type ? typeof t[0] !== e.type : 'function' != typeof e.type || !e.type(t[0]))) &&
						...
						n.dash_animOptions
							? ((o = Xe(t, a, 'dash_maxOffset', n.dash_maxOffset)),
								a.dash_animOptions &&
									...
									(n.dash_animId && ((e = g.stop(n.dash_animId)), g.remove(n.dash_animId)), (a.dash_animOptions = null)),
								a.dash_animOptions ||
									((n.dash_animId = g.add(
										function (e) {
			...
			draw: {
				...
				stop: function (e, t, n) {
					...
					return (
						...
						(i.show_inAnim = !1),
						t &&
							((e.pathList.animVal = n ? null : [[e.pathList.baseVal[0][0], e.pathList.baseVal[0][0]]]), $e(e, { path: !0 }), Je(e, n)),
						a
					)
				},
				update: function (e) {
					;(De(e, 'apl_position', w.draw.update),
						e.curStats.show_inAnim ? w.draw.init(e, w.draw.stop(e)) : (e.aplStats.show_animOptions = {}))
				}
			}
		}),
		[
			...
			pointAnchor: {
				...
				parsePercent: function (e, t) {
					var n,
						...
						i = !1
					return (
						pe(e) ? (a = e) : 'string' == typeof e && (n = m.exec(e)) && n[2] && (i = 0 !== (a = parseFloat(n[1]) / 100)),
						...
						'circle' === e.shape
							...
							: 'polygon' === e.shape &&
								  ...
								  e.points.every(function (e) {
										var t = {}
										return (
											!(!(t.x = O.pointAnchor.parsePercent(e[0], !0)) || !(t.y = O.pointAnchor.parsePercent(e[1], !0))) &&
					...
					return (
						...
						t.dash &&
							((!v.pathData && (!v.strokeWidth || (t.dashLen && t.dashGap))) ||
								((S.dashLen = t.dashLen || 2 * S.strokeWidth), (S.dashGap = t.dashGap || S.strokeWidth)),
			...
			mouseHoverAnchor: {
				...
				init: function (a, i) {
					...
					if (
						...
						(s = a.element),
						!((u = s.ownerDocument) && (h = u.defaultView) && h.HTMLElement && s instanceof h.HTMLElement))
					)
					...
					return (
						...
						'inline' === (n = a.element.ownerDocument.defaultView.getComputedStyle(a.element, '')).display
				...
				unbind: function (e, t) {
					;(e.enabled &&
						...
						(e.removeEventListener(), O.mouseHoverAnchor.setStyles(e.elmStyle, e.styleSave), (e.enabled = !1)),
						...
						!!l.text &&
							...
							re &&
								(l.adjustEdge = function (e, t) {
									var n = l.curStats
									null != n.x &&
										O.captionLabel.adjustEdge(t, { x: n.x, y: n.y, width: l.width, height: l.height }, l.strokeWidth / 2)
								}),
							!0)
					)
				},
					...
					return (
						...
						i && !h
							...
							: ((l = r.style),
								...
								{ elmPosition: r, styleText: l, styleFill: l, styleStroke: i ? l : null, styleShow: l, elmsAppend: [r] })
					)
				},
			...
			pathLabel: {
					...
					return (
						...
						!!l.text &&
							...
							(l.updatePath = function (e) {
								...
								i &&
									((t.pathData = a =
										O.pathLabel.getOffsetPathData(i, a.line_strokeWidth / 2 + l.strokeWidth / 2 + l.height / 4, 1.25 * l.height)),
									Fe(a, n.pathData) &&
										(l.elmPath.setPathData(a), (n.pathData = a), (l.bBox = l.elmPosition.getBBox()), l.updateStartOffset(e)))
							}),
						...
						e.forEach(function (e) {
							...
							2 === e.length
								? ((s = e[0]),
									...
									d
										? ((a = d.points),
											0 <= (r = Math.atan2(a[1].y - a[0].y, a[0].x - a[1].x) - Math.atan2(e[0].y - e[1].y, e[1].x - e[0].x)) &&
											r <= Math.PI
				...
				initSvg: function (t, n) {
					...
					;(['elmPosition', 'elmPath', 'elmOffset', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function (e) {
						...
						2 !== t.semIndex ||
							t.lineOffset ||
							o.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE, 50),
						(t.height = e.height),
						t.outlineColor &&
							((a = e.height / 9),
