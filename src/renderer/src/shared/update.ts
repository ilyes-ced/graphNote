...
const updateActivityCounter = (nodeId: string, date: string, newValue: number) => {
...
const newDocumentNode = (path: string, x: number, y: number) => {
	const activeBoardId = getActiveBoardId()
...
function findNodeDeep(parentId: string, targetId: string): { parentId: string; index: number } | null {
