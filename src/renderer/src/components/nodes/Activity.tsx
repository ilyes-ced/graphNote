	...
	return (
		<div class="">
			<Show when={node.top_strip_color}>
				<div class="top_strip" style={{ background: node.top_strip_color }}></div>
			</Show>

			<div class="p-5  overflow-auto">
				{/* title */}
				<div class="flex mb-4">
					<div class="ActivityButton1 border-2 border-border size-14 flex justify-center items-center">logo</div>
					<div class="flex-1 px-4">
						<div class="activityTitle text-xl font-bold ">title</div>
						<div class="activityDesc ">desc</div>
					</div>
					<div class="ActivityButton2 border-2 border-border size-14 flex justify-center items-center">logo</div>
				</div>
				{/* heatmap */}
