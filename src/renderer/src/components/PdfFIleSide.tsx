...
export default () => {
    ...
    return (
        ...
        store.userConfig.pdfReaderType === "side" ?
            //? slide pdf reader
            <div
            ...
            <Show when={store.pdfFile != null}>
                <Portal>
                    <div class="z-10000 absolute top-0 left-0 size-full  backdrop-blur-md" onClick={() => setStore("pdfFile", null)}>
                        <div onClick={(e) => e.stopPropagation()} id="pdf_reader_modal_content" class="bg-background absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-primary animate-[modalIn_0.25s_ease] size-10/12 ">
